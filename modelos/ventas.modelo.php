...
require_once "conexion.php"; 
 class VentasModelo {
     static public function mdlObtenerNroBoleta() {
      ...
      static public function mdlRegistrarVenta($datos,$nro_boleta,$total_venta,$descripcion_venta,$subtotal,$igv,$tipo_comprobante,$tipo_pago){

        $stmt = Conexion::conectar()->prepare("INSERT INTO venta_cabecera(nro_boleta,descripcion,subtotal,igv,total_venta, tipo_comprobante, tipo_pago)         
                                                VALUES(:nro_boleta,:descripcion,:subtotal, :igv,:total_venta,:tipo_comprobante,:tipo_pago)");
